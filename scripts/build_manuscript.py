...
t_m3=table('tableS8','Table S8. Fully adjusted (Model 3) prevalence ratios for all covariates',['Characteristic','PR (95% CI)','P value'],rows,'The model includes an age spline with 3 degrees of freedom. Spline basis coefficients and the intercept are retained in the accompanying results files; they do not individually represent clinical group contrasts. No multiplicity correction was applied. Sparse race and military-coverage contrasts require caution.')
...
supp+=table('tableS11','Table S11. Convergence and fitted-value diagnostics for the modified Poisson models',['Model','No.','No. with barrier','Fitted values >1 per imputation','Largest fitted value','Convergence'],rows,'Ten fits per specification (one per income imputation). Fitted log-link values above one are not interpreted as individual probabilities. The bounded logistic sensitivity (Table S10) supports the major associations. Age-group models replace the age spline with an age-group indicator.')
