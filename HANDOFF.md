...
**Update, 22 September 2026 (readiness pass):** every number in the text was re-verified against the result files; supplemental tables were renumbered S1–S12 in order of first citation; references and supplemental tables are now cited in strict numeric order; confidence intervals no longer nest inside parentheses; minus signs are typographic; variable and model names in supplemental tables use plain-language labels; reference 11 and 15 formatting was corrected; and release v1.2.0 is the version cited in the manuscript.

**Update, 18 September 2026 (evening):** the package was polished to a submission candidate. The manuscript was rewritten for a journal audience (new title, sharper abstract and discussion, two added references including the 2026 AHA statistical update and Ansong et al. 2026), all process narration was removed from the manuscript and supplement, the Word output was restyled (12-point Times New Roman, double spacing, page breaks, AMA-style references, journal table formatting), and the three figures were rebuilt as two-panel publication figures with 300-dpi PNG/TIFF and vector PDF exports. Every page of both PDFs was inspected. Release v1.2.0 is cited in the manuscript.

**Update, 19 September 2026:** formatted to the journal *Stroke* (AHA) instructions: section order and end matter (Acknowledgments with the AI-use disclosure, Sources of Funding "None", Disclosures "None", Supplemental Material list), Non-standard Abbreviations list after the abstract, Data Availability and full-data-access statement in Methods, references listing up to ten authors in AHA style, tables ruled only above/below headings and at the bottom, figures with legends on their own pages, page numbers omitted from the title page, line numbering removed at the authors' request, and a 7 x 7 in JPG graphic abstract (scripts/make_graphical_abstract.R). Still needed from the authors for Stroke: academic degrees on the title page and a complete postal address for the corresponding author.
